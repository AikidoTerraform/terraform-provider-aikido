...
- `post_deep_audit_inline_comments_min_severity` (String, Deprecated) Ignored and has no effect. Kept only for backward compatibility. One of: none, low, medium, high, critical.
