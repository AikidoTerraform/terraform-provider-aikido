...
- `aikido_task_tracking_team_mapping` maps Aikido teams to task-tracker projects (Linear, Jira, …). Keys are tracker project IDs; values are Aikido team IDs. Destroy only removes the resource from Terraform state.
