...
provider_installation {
  dev_overrides {
    "aikido/aikido" = "/Users/YOU/go/bin"
...
With `dev_overrides` enabled, `terraform init` will warn that it is skipping registry installation for `aikido/aikido` — that is expected.
...
# provider_installation { dev_overrides { "aikido/aikido" = "$(go env GOPATH)/bin" } direct {} }
